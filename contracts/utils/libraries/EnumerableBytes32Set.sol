...
/**
 * @title Library for utilising enumerated bytes32 sets.
 *
 * @notice Sets have the following properties:
 * values are stored as bytes32[] and mapping of array indexes bytes32 => uint256
 *
...
library EnumerableBytes32Set {
	...
	function enumerateAll(Bytes32Set storage set) internal view returns (bytes32[] memory output) {
